	...
	<div class="um_box_mid">
		<div class="um_box_mid_content">
			<div class="um_box_mid_content_top">
				<span class="umstyle1"><?php echo __('Sign In'); ?></span>
				<span  class="umstyle2"><?php // echo $this->Html->link(__("Sign Up",true),"/register") ?></span>
				<span class="umstyle2" style="float:right"><?php echo $this->Html->link($this->Html->image('/img/admin/login.png'),"/admin/",array('escape' => false)) ; ?></span>
...
//								$this->request->data['User']['remember']=true;
					...
					<div class="underButtons"><?php echo $this->Html->link(__("Forgot Password?",true),"/forgotPassword",array("class"=>"style30")) ?></div>
					<div  class="underButtons"><?php echo $this->Html->link(__("Email Verification",true),"/emailVerification",array("class"=>"style30")) ?></div>
				</div>
