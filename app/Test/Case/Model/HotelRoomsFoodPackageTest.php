<?php
App::uses('HotelRoomsFoodPackage', 'Model');

/**
 * HotelRoomsFoodPackage Test Case
 *
 */
class HotelRoomsFoodPackageTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HotelRoomsFoodPackage = ClassRegistry::init('HotelRoomsFoodPackage');
	}
 ...
 */
	public function tearDown() {
		unset($this->HotelRoomsFoodPackage);
