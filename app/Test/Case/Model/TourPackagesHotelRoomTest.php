<?php
App::uses('TourPackagesHotelRoom', 'Model');

/**
 * TourPackagesHotelRoom Test Case
 *
 */
class TourPackagesHotelRoomTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TourPackagesHotelRoom = ClassRegistry::init('TourPackagesHotelRoom');
	}
 ...
 */
	public function tearDown() {
		unset($this->TourPackagesHotelRoom);
