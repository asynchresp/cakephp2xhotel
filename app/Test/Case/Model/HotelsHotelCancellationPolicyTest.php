<?php
App::uses('HotelsHotelCancellationPolicy', 'Model');

/**
 * HotelsHotelCancellationPolicy Test Case
 *
 */
class HotelsHotelCancellationPolicyTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HotelsHotelCancellationPolicy = ClassRegistry::init('HotelsHotelCancellationPolicy');
	}
 ...
 */
	public function tearDown() {
		unset($this->HotelsHotelCancellationPolicy);
