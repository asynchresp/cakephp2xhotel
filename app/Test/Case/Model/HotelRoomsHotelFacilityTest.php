<?php
App::uses('HotelRoomsHotelFacility', 'Model');

/**
 * HotelRoomsHotelFacility Test Case
 *
 */
class HotelRoomsHotelFacilityTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HotelRoomsHotelFacility = ClassRegistry::init('HotelRoomsHotelFacility');
	}
 ...
 */
	public function tearDown() {
		unset($this->HotelRoomsHotelFacility);
