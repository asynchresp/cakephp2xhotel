<?php
App::uses('PointNearByHotel', 'Model');

/**
 * PointNearByHotel Test Case
 *
 */
class PointNearByHotelTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->PointNearByHotel = ClassRegistry::init('PointNearByHotel');
	}
