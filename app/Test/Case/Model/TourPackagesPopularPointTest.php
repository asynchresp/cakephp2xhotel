<?php
App::uses('TourPackagesPopularPoint', 'Model');

/**
 * TourPackagesPopularPoint Test Case
 *
 */
class TourPackagesPopularPointTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TourPackagesPopularPoint = ClassRegistry::init('TourPackagesPopularPoint');
	}
 ...
 */
	public function tearDown() {
		unset($this->TourPackagesPopularPoint);
