<?php
App::uses('HotelRoomsFoodMenuType', 'Model');

/**
 * HotelRoomsFoodMenuType Test Case
 *
 */
class HotelRoomsFoodMenuTypeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HotelRoomsFoodMenuType = ClassRegistry::init('HotelRoomsFoodMenuType');
	}
 ...
 */
	public function tearDown() {
		unset($this->HotelRoomsFoodMenuType);
