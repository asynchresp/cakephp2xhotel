<?php
App::uses('HotelRoomsHotelFacilityCategory', 'Model');

/**
 * HotelRoomsHotelFacilityCategory Test Case
 *
 */
class HotelRoomsHotelFacilityCategoryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HotelRoomsHotelFacilityCategory = ClassRegistry::init('HotelRoomsHotelFacilityCategory');
	}
 ...
 */
	public function tearDown() {
		unset($this->HotelRoomsHotelFacilityCategory);
