<?php
App::uses('TourPackagesTax', 'Model');

/**
 * TourPackagesTax Test Case
 *
 */
class TourPackagesTaxTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TourPackagesTax = ClassRegistry::init('TourPackagesTax');
	}
