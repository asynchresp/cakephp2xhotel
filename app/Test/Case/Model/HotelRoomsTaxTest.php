<?php
App::uses('HotelRoomsTax', 'Model');

/**
 * HotelRoomsTax Test Case
 *
 */
class HotelRoomsTaxTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HotelRoomsTax = ClassRegistry::init('HotelRoomsTax');
	}
