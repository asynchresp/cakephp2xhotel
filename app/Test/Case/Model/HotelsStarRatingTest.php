<?php
App::uses('HotelsStarRating', 'Model');

/**
 * HotelsStarRating Test Case
 *
 */
class HotelsStarRatingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HotelsStarRating = ClassRegistry::init('HotelsStarRating');
	}
