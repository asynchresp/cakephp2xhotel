<?php
App::uses('HotelsHotelTheme', 'Model');

/**
 * HotelsHotelTheme Test Case
 *
 */
class HotelsHotelThemeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HotelsHotelTheme = ClassRegistry::init('HotelsHotelTheme');
	}
