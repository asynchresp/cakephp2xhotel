<?php
App::uses('TourPackage', 'Model');

/**
 * TourPackage Test Case
 *
 */
class TourPackageTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TourPackage = ClassRegistry::init('TourPackage');
	}
