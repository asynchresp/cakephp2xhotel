<?php
App::uses('HotelsPointNearByHotel', 'Model');

/**
 * HotelsPointNearByHotel Test Case
 *
 */
class HotelsPointNearByHotelTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HotelsPointNearByHotel = ClassRegistry::init('HotelsPointNearByHotel');
	}
 ...
 */
	public function tearDown() {
		unset($this->HotelsPointNearByHotel);
