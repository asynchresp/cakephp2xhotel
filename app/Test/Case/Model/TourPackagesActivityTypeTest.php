<?php
App::uses('TourPackagesActivityType', 'Model');

/**
 * TourPackagesActivityType Test Case
 *
 */
class TourPackagesActivityTypeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TourPackagesActivityType = ClassRegistry::init('TourPackagesActivityType');
	}
 ...
 */
	public function tearDown() {
		unset($this->TourPackagesActivityType);
