<?php
App::uses('HotelsHotelTyep', 'Model');

/**
 * HotelsHotelTyep Test Case
 *
 */
class HotelsHotelTyepTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HotelsHotelTyep = ClassRegistry::init('HotelsHotelTyep');
	}
