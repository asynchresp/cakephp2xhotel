<?php
App::uses('HotelsHotelModificationPolicy', 'Model');

/**
 * HotelsHotelModificationPolicy Test Case
 *
 */
class HotelsHotelModificationPolicyTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HotelsHotelModificationPolicy = ClassRegistry::init('HotelsHotelModificationPolicy');
	}
 ...
 */
	public function tearDown() {
		unset($this->HotelsHotelModificationPolicy);
