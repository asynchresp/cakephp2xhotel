<?php
App::uses('HotelsHotelFacilityCategory', 'Model');

/**
 * HotelsHotelFacilityCategory Test Case
 *
 */
class HotelsHotelFacilityCategoryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HotelsHotelFacilityCategory = ClassRegistry::init('HotelsHotelFacilityCategory');
	}
 ...
 */
	public function tearDown() {
		unset($this->HotelsHotelFacilityCategory);
