<?php
App::uses('TourPackagesActivityTypesController', 'Controller');

/**
 * TourPackagesActivityTypesController Test Case
 *
 */
class TourPackagesActivityTypesControllerTest extends ControllerTestCase {
