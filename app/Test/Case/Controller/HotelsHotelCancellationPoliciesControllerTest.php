<?php
App::uses('HotelsHotelCancellationPoliciesController', 'Controller');

/**
 * HotelsHotelCancellationPoliciesController Test Case
 *
 */
class HotelsHotelCancellationPoliciesControllerTest extends ControllerTestCase {
