<?php
App::uses('HotelsHotelFacilitiesController', 'Controller');

/**
 * HotelsHotelFacilitiesController Test Case
 *
 */
class HotelsHotelFacilitiesControllerTest extends ControllerTestCase {
