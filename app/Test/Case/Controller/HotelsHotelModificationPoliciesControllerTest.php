<?php
App::uses('HotelsHotelModificationPoliciesController', 'Controller');

/**
 * HotelsHotelModificationPoliciesController Test Case
 *
 */
class HotelsHotelModificationPoliciesControllerTest extends ControllerTestCase {
