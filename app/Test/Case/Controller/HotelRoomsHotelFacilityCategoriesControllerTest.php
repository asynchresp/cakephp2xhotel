<?php
App::uses('HotelRoomsHotelFacilityCategoriesController', 'Controller');

/**
 * HotelRoomsHotelFacilityCategoriesController Test Case
 *
 */
class HotelRoomsHotelFacilityCategoriesControllerTest extends ControllerTestCase {
