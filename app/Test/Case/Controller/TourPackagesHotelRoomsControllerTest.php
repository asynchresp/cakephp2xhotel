<?php
App::uses('TourPackagesHotelRoomsController', 'Controller');

/**
 * TourPackagesHotelRoomsController Test Case
 *
 */
class TourPackagesHotelRoomsControllerTest extends ControllerTestCase {
