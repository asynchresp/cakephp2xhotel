<?php
App::uses('HotelsPointNearByHotelsController', 'Controller');

/**
 * HotelsPointNearByHotelsController Test Case
 *
 */
class HotelsPointNearByHotelsControllerTest extends ControllerTestCase {
