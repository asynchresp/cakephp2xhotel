<?php
App::uses('HotelRoomsFoodMenuTypesController', 'Controller');

/**
 * HotelRoomsFoodMenuTypesController Test Case
 *
 */
class HotelRoomsFoodMenuTypesControllerTest extends ControllerTestCase {
