<?php
App::uses('HotelRoomsHotelFacilitiesController', 'Controller');

/**
 * HotelRoomsHotelFacilitiesController Test Case
 *
 */
class HotelRoomsHotelFacilitiesControllerTest extends ControllerTestCase {
