<?php
App::uses('TourPackagesPopularPointsController', 'Controller');

/**
 * TourPackagesPopularPointsController Test Case
 *
 */
class TourPackagesPopularPointsControllerTest extends ControllerTestCase {
