...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Hotel Room'), array('action' => 'delete', $hotelRoom['HotelRoom']['id']), null, __('Are you sure you want to delete # %s?', $hotelRoom['HotelRoom']['id'])); ?> </li>
