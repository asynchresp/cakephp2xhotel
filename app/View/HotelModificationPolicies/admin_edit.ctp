...
<?php echo $this->Form->create('HotelModificationPolicy'); ?>
	<fieldset>
		<legend><?php echo __('Edit Hotel Modification Policy'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('HotelModificationPolicy.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('HotelModificationPolicy.id'))); ?></li>
