<div class="hotelModificationPolicies view">
<h2><?php echo __('Hotel Modification Policy'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($hotelModificationPolicy['HotelModificationPolicy']['id']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($hotelModificationPolicy['HotelModificationPolicy']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Description'); ?></dt>
		<dd>
			<?php echo html_entity_decode(h($hotelModificationPolicy['HotelModificationPolicy']['description'])); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('No Before Days'); ?></dt>
		<dd>
			<?php echo h($hotelModificationPolicy['HotelModificationPolicy']['no_before_days']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Perentage Deducted'); ?></dt>
		<dd>
			<?php echo h($hotelModificationPolicy['HotelModificationPolicy']['perentage_deducted']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Status'); ?></dt>
		<dd>
			<?php if(h($hotelModificationPolicy['HotelModificationPolicy']['status']) == 1) { echo "Active"; } else { echo "Inactive"; } ?>&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($hotelModificationPolicy['HotelModificationPolicy']['modified']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($hotelModificationPolicy['HotelModificationPolicy']['created']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Hotel Modification Policy'), array('action' => 'edit', $hotelModificationPolicy['HotelModificationPolicy']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Hotel Modification Policy'), array('action' => 'delete', $hotelModificationPolicy['HotelModificationPolicy']['id']), null, __('Are you sure you want to delete # %s?', $hotelModificationPolicy['HotelModificationPolicy']['id'])); ?> </li>
...
<?php /* ?><div class="related">
	...
	<?php if (!empty($hotelModificationPolicy['Hotel'])): ?>
	...
	<?php
		$i = 0;
		foreach ($hotelModificationPolicy['Hotel'] as $hotel): ?>
		<tr>
