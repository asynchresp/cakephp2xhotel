<div class="countries index">
    <div class="um_box_mid_content_top"><span class="umstyle1"><?php echo __('Countries'); ?></span></div>
	...
	<tr>
		...
		<?php /* ?><td><?php echo h($country['Country']['description']); ?>&nbsp;</td><?php */ ?>
		<td><?php if(h($country['Country']['status']) == 1) { echo "Active"; } else { echo "Inactive"; } ?>&nbsp;</td>
		<?php /* ?><td><?php echo h($country['Country']['modified']); ?>&nbsp;</td>
		<td><?php echo h($country['Country']['created']); ?>&nbsp;</td><?php */ ?>
		<td class="actions">
