<div class="countries view">
    <div class="um_box_mid_content_top"><span class="umstyle1"><?php echo __('Country'); ?></span></div>
...
<!--<h2><?php // echo __('Country'); ?></h2>-->
	<dl>
		...
		<dd>
			<?php echo html_entity_decode(h($country['Country']['description'])); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Status'); ?></dt>
		<dd>
			<?php if(h($country['Country']['status']) == 1) { echo "Active"; } else { echo "Inactive"; } ?>
			&nbsp;
		</dd>
...
<?php /* ?><div class="related">
	...
	<?php
		...
		<tr>
			...
			<td><?php echo $area['country_id']; ?></td>
			<td><?php echo $area['state_id']; ?></td>
			<td><?php echo $area['city_id']; ?></td>
...
<div class="related">
	...
	<?php if (!empty($country['HotelRoom'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Country Id'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($country['HotelRoom'] as $hotelRoom): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($country['PointNearByHotel'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Site Id'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($country['PointNearByHotel'] as $pointNearByHotel): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($country['PopularPoint'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Site Id'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($country['PopularPoint'] as $popularPoint): ?>
		<tr>
