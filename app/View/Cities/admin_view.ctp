<div class="cities view">
    <div class="um_box_mid_content_top"><span class="umstyle1"><?php echo __('City'); ?></span></div>
...
<!--<h2><?php // echo __('City'); ?></h2>-->
	<dl>
		...
		<dd>
			<?php if(h($city['City']['status']) == 1) { echo "Active"; } else { echo "Inactive"; } ?>
			&nbsp;
		</dd>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($city['HotelRoom'] as $hotelRoom): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($city['PointNearByHotel'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Site Id'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($city['PointNearByHotel'] as $pointNearByHotel): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($city['PopularPoint'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Site Id'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($city['PopularPoint'] as $popularPoint): ?>
		<tr>
