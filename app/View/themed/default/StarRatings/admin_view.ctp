...
<h2><?php echo __('Star Rating'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($starRating['StarRating']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($starRating['StarRating']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Shortcode'); ?></dt>
		<dd>
			<?php echo h($starRating['StarRating']['shortcode']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Image'); ?></dt>
		<dd>
			<?php echo h($starRating['StarRating']['image']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Status'); ?></dt>
		<dd>
			<?php if(h($starRating['StarRating']['status']) == 1) { echo "Active"; } else { echo "Inactive"; } ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($starRating['StarRating']['modified']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($starRating['StarRating']['created']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($starRating['Hotel'] as $hotel): ?>
		<tr>
