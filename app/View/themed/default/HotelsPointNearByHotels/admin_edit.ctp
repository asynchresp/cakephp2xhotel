...
<?php echo $this->Form->create('HotelsPointNearByHotel'); ?>
	<fieldset>
		<legend><?php echo __('Edit Hotels Point Near By Hotel'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('HotelsPointNearByHotel.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('HotelsPointNearByHotel.id'))); ?></li>
