...
<?php echo $this->Form->create('HotelFacilityCategoriesHotelFacility'); ?>
	<fieldset>
		<legend><?php echo __('Edit Hotel Facility Categories Hotel Facility'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('HotelFacilityCategoriesHotelFacility.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('HotelFacilityCategoriesHotelFacility.id'))); ?></li>
