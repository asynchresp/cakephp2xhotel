...
<div id="header-bg">
	...
	<div id="header">
		<a href="index.html"><img src="..img/logo.gif" alt="Package" width="205" height="62" border="0" class="logo" title="Package" /></a>
		...
		<div id="login-bg">
			...
			<div id="login-area">
				<form action="" method="post" name="Login" id="Login">
					...
					<input type="image" src="..img/login-btn.gif" class="login-btn" alt="Login" title="Login" />
					<br class="spacer" />
				</form>
			</div>
			<!--Login Area Ends -->
