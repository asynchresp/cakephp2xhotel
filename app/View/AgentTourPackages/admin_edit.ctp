...
<?php echo $this->Form->create('AgentTourPackage'); ?>
	<fieldset>
		<legend><?php echo __('Edit Agent Tour Package'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AgentTourPackage.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('AgentTourPackage.id'))); ?></li>
