<div class="hotelRoomsHotelFacilityCategories form">
    <div class="um_box_mid_content_top"><span class="umstyle1"><?php echo __('Add Hotel Rooms Hotel Facility Category'); ?></span></div>
    <div class="content_mid">
<?php echo $this->Form->create('HotelRoomsHotelFacilityCategory'); ?>
	<fieldset>
		<!--<legend><?php // echo __('Add Hotel Rooms Hotel Facility Category'); ?></legend>-->
	<?php
