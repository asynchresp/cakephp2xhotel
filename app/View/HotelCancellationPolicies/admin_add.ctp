<div class="hotelCancellationPolicies form">
    <div class="um_box_mid_content_top"><span class="umstyle1"><?php echo __('Add Hotel Cancellation Policy'); ?></span></div>
    <div class="content_mid">
<?php echo $this->Form->create('HotelCancellationPolicy'); ?>
	<fieldset>
		<!--<legend><?php // echo __('Add Hotel Cancellation Policy'); ?></legend>-->
	<?php
